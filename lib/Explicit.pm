#
# Explicit.pm -- Perl module for instance generation of explicit cost function. 
#
...
# a XML file containing a random explicit instance of the specified 2 ** size.
#
sub random_explicit_instance
{
  ...
  {
    printf XML "  <Cost>\n    <name>_%0". $size . "b</name>\n", $i;
    printf XML "    <value> %f  </value>\n  </Cost>", rand ($MAX_ELEMENT_VALUE);
  }
