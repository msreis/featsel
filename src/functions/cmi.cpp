// cmi.cpp automatically generated by bin/add_new_cost_function.pl
// in Wed Feb  8 05:34:13 2017.

//
// cmi.cpp -- implementation of the class "cmi".
//
...
float cmi::cost (ElementSubset * X)
{
  timeval begin, end;
