...
#include "functions/SigNetSimTest.h"
...
#include "algorithms/UCSRTest.h"
#include "algorithms/RandomUChainTest.h"
#include "algorithms/KRandomUChainTest.h"
#include "algorithms/CHCGATest.h"
#include "algorithms/RBMTest.h"
#include "algorithms/PUCSTest.h"
#include "algorithms/PosetForestSearchTest.h"
#include "algorithms/OscillationTest.h"
...
int main (void)
{
  ...
  //Testing class "CHCGA"
  //
  current_class = "CHCGATest";
  result ("it_should_store_all_the_visited_subsets",
    CHCGATest::it_should_store_all_the_visited_subsets ());
  result ("it_should_give_the_number_of_the_visited_subsets",
    CHCGATest::it_should_give_the_number_of_the_visited_subsets ());
  cout << endl;

  //Testing class "RBM"
  //
  current_class = "RBMTest";
  result ("it_should_store_all_the_visited_subsets",
    RBMTest::it_should_store_all_the_visited_subsets ());
  result ("it_should_give_the_number_of_the_visited_subsets",
    RBMTest::it_should_give_the_number_of_the_visited_subsets ());
  cout << endl;
  ...
  //Testing class "Oscillation"
  //
  current_class = "OscillationTest";
  result ("it_should_store_all_the_visited_subsets",
    OscillationTest::it_should_store_all_the_visited_subsets ());
  result ("it_should_give_the_number_of_the_visited_subsets",
    OscillationTest::it_should_give_the_number_of_the_visited_subsets ());
  cout << endl;
