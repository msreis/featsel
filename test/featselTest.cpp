...
#include "functions/miTest.h"
#include "functions/cmiTest.h"
...
#include "algorithms/spec_cmiTest.h"
...
int main (void)
{
  ...
  //Testing class "mi"
  //
  current_class = "miTest";
  result ("an_empty_set_should_have_cost_zero",
    miTest::an_empty_set_should_have_cost_zero ());
  result ("it_should_add_and_retrieve_the_elapsed_time",
    miTest::it_should_add_and_retrieve_the_elapsed_time ());
  cout << endl;

  //Testing class "cmi"
  //
  current_class = "cmiTest";
  result ("an_empty_set_should_have_cost_zero",
    cmiTest::an_empty_set_should_have_cost_zero ());
  result ("it_should_add_and_retrieve_the_elapsed_time",
    cmiTest::it_should_add_and_retrieve_the_elapsed_time ());
  cout << endl;
  ...
  */
  ...
  //Testing class "spec_cmi"
  //
  current_class = "spec_cmiTest";
  result ("it_should_store_all_the_visited_subsets",
    spec_cmiTest::it_should_store_all_the_visited_subsets ());
  result ("it_should_give_the_number_of_the_visited_subsets",
    spec_cmiTest::it_should_give_the_number_of_the_visited_subsets ());
  cout << endl;
