//
// SubsetSumTest.cpp -- implementation of the namespace "SubsetSumTest".
//
...
namespace SubsetSumTest
{
  ...
  {
    ElementSet set ("set", "input/subset_sum/Test_03_A.xml");
    ...
    X.add_element (0);
    X.add_element (2);   // X = [101]
    Y.add_element (1);
    Y.add_element (2);   // Y = [011]
